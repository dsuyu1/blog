...
Props to Claude for helping me crack this one. My original Python implementation couldn't get past the first few tests..but even Claude had trouble with this problem. I had to give it a few pointers, and it was more like having a decent programming buddy than anything. Also, I'm a C++ noob and Python abuser, so there's that.